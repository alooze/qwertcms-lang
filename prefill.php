...
$fields = [
    ...
    'author_github_username' => ['Your Github username',  '<alooze> in https://github.com/alooze',       'alooze'],
    'author_email' =>           ['Your email address',    'a.looze@gmail.com',                                                'a.looze@gmail.com'],
    ...
    'package_vendor' =>         ['Package vendor',        '<alooze> in https://github.com/alooze/package',   '{author_github_username}'],
    'package_name' =>           ['Package name',          '<qwertcms-lang> in https://github.com/alooze/qwertcms-lang',  'Qwertcms-lang'],
    'package_description' =>    ['Package very short description',   'Lang module for QWERT CMS',                                     ''],

    'psr4_namespace' =>         ['PSR-4 namespace',       'usually, Vendor\\Package',                        'alooze\\QwertCms'],
];
